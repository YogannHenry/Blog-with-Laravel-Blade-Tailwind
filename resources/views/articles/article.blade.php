<x-app-layout>
    <div class="w-full  h-128 bg-gradient-to-r from-slate-600 to-black relative z-0" >
    <video autoplay muted loop style="position: absolute; z-index: -1; top: 0; left: 0; width: 120%; height: 100%;">
        ...
        <p class="font-semibold font-mono text-xl  mt-20 leading-tight text-white  ml-44 "> {{ $article->text}}</p>
